    ...
    assetClass: [
      {
        title: 'Stocks',
        description:
          'Stocks act as the core asset class because history demonstrates that they offer significant returns over the long run.',
      },
      {
        title: 'Commodities',
        description:
          'Commodities such as Gold provide a hedge against inflation. Our return expectations for Commodities is positive due to their limited supply and the growing demand from emerging market economies.',
      },
      {
        title: 'Fixed Income',
        description:
          'Sukuk represents the Fixed Income exposure for Shari’ah compliant investments. It is a primacy of equity financing. This asset class provides stable and low risk return along with diversification benefits.',
      },
      {
        title: 'Cash',
        description:
